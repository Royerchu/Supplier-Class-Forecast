...
**Business Goal:** Using CycNorm(Normalization of Cycletime), DefNorm(Normalization of DefectRate), and CosNorm(Normalization of Cost) to predict the class level(Gold, Silver, Tin, Platinum)
